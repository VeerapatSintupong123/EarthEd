...
const HeroQuest: React.FC = () => {
  ...
  return (
    <div className="">
      <section className="w-full px-8 py-8 grid grid-cols-1 md:grid-cols-2 items-center gap-8 max-w-6xl mx-auto bg-slate-400 rounded-xl">
        <div>
        ...
        <div
          className="min-w-full h-[300px] bg-slate-50  rounded-lg"
